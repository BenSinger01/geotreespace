...
tree_a <- read.beast(test_path("examples", "mtGeo.MCC.txt"))
tree_b <- read.beast(test_path("examples", "yGeo.MCC.txt"))
tree_c <- read.beast(test_path("examples", "autoGeo.MCC.txt"))
