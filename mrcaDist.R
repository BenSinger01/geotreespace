...
#' @param continuous (optional) logical specifying whether to expect discrete location names (FALSE) or 2-dimensional co-ordinates called coord_name1 and coord_name2 (TRUE).
...
#' @param coord_name (optional) a string specifying the name of the column in the tree data containing geographic locations.
#' @param continuous (optional) logical specifying whether to expect discrete location names (FALSE) or 2-dimensional co-ordinates called coord_name1 and coord_name2 (TRUE).
#' @param distance.matrix (optional) a matrix of distances between locations as stored in the data of \code{tree.a} and \code{tree.b}. If not provided, and continuous = FALSE, then the distance between all locations is set to one.
